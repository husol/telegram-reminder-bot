...
const HandlePatternRemindList = "/remindlist"

func HandleRemindList(reminderListService RemindListServicer, buttons map[string]*telebot.InlineButton) func(c tbwrap.Context) error {
